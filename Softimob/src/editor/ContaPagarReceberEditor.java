...
import modelo.ContaPagarReceber;
import modelo.LancamentoContabil;
import modelo.MovimentacaoContabil;
import modelo.OrigemConta;
...
public class ContaPagarReceberEditor extends EditorPart {
	...
	public static final String ID = "editor.ContaPagarReceberEditor"; //$NON-NLS-1$
	private Text text;
	private Table table;
